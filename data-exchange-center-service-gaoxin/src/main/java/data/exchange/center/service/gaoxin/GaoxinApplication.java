package data.exchange.center.service.gaoxin;
...
@MapperScan("data.exchange.center.service.gaoxin.mapper")
@SpringBootApplication
@EnableDiscoveryClient
@EnableFeignClients
public class GaoxinApplication {

	public static void main(String[] args) {
		SpringApplication.run(GaoxinApplication.class, args);
	}
	/**
	 * 
	 * @function feign取消重试
