...
public class TestMakeXml_AJXX_XS {
	...
	public static void main(String[] args) throws IOException {
	    ...
	    node1.addElement("公诉机关").addText("");
	    node1.addElement("诉讼性质代码").addText("");
	    node1.addElement("诉讼性质名称").addText("");
	    node1.addElement("是否附带民事诉讼代码").addText("");
	    node1.addElement("是否附带民事诉讼名称").addText("");
	    ...
	    r10.addElement("类型代码").addText("");
	    r10.addElement("类型名称").addText("");
	    r10.addElement("诉讼地位代码").addText("");
	    r10.addElement("诉讼地位名称").addText("");
	    r10.addElement("名称").addText("");
	    r10.addElement("法定代表人").addText("");
	    ...
	    r12.addElement("类型代码").addText("");
	    r12.addElement("类型名称").addText("");
	    r12.addElement("诉讼地位代码").addText("");
	    r12.addElement("诉讼地位名称").addText("");
	    r12.addElement("名称").addText("");
	    r12.addElement("法定代表人").addText("");
	    ...
	    r16.addElement("姓名").addText("");
	    r16.addElement("角色代码").addText("");
	    r16.addElement("角色名称").addText("");
	    r16.addElement("联系电话").addText("");
	    ...
	    r19.addElement("类型代码").addText("");
	    r19.addElement("类型名称").addText("");
	    r19.addElement("诉讼地位代码").addText("");
	    r19.addElement("诉讼地位名称").addText("");
	    r19.addElement("附带民诉当事人").addText("");

	    Element node20 = root.addElement("刑事附带民事信息");
	    node20.addElement("编号").addText("");
	    node20.addElement("案件编号").addText("");
	    node20.addElement("提起人类型代码").addText("");
	    node20.addElement("提起人类型名称").addText("");
	    node20.addElement("提起诉讼日期").addText("");
	    node20.addElement("处理日期").addText("");
	    node20.addElement("处理方式代码").addText("");
	    node20.addElement("处理方式名称").addText("");
	    node20.addElement("请求赔偿金额").addText("");
	    ...
	    r23.addElement("证据名称").addText("");
	    r23.addElement("证据类型代码").addText("");
	    r23.addElement("证据类型名称").addText("");
		...
		XMLWriter xmlWriter = new XMLWriter(new FileOutputStream("D://XS1.xml"), format);
