...
public class RSATool {
	...
	public static Object[] giveRSAKeyPairInByte() {
		...
		if (newKeyPair != null) {
			...
			re[0] = b_priv;
			re[1] = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCflZaYF13v52SGYV2qyXeVfEAqy0RzH/8d3MTPuSqw4nAD1DSpqwU5g6Tq7Krf276exTmt7+ZpAYz0rDuxLN6z79XOlwXC/hNwcUXFbxNJJM6igxWSevt9NrQstKy0TmZnOvjpXmTcQzXpOwhGxtvBAWDcEylB+KviH2IsVDPtsQIDAQAB"
					.getBytes();
			return re;
		}
		return null;
	...
	public static void main(String[] args) {
		try {
			...
			// 获得摘要
			byte[] source = MdigestSHA(
					"{\"FYBH\":\"3000\",\"GXJSSJ\":\"2018-04-24 23:59:59.999\",\"GXKSSJ\":\"2018-04-01 00:00:00.000\",\"VERSION\":\"1.3\",\"YWLX\":\"KTGG\"}");
			...
			// 私钥加密公钥解密
			// 获得摘要
			// byte[] sourcepri_pub = MdigestSHA("{"FYBH":"3000","GXJSSJ":"2018-04-24
			// 23:59:59.999","GXKSSJ":"2018-04-01
			// 00:00:00.000","VERSION":"1.3","YWLX":"KTGG"}");
			byte[] sourcepri_pub = ("{\"FYBH\":\"3000\",\"GXJSSJ\":\"2018-04-24 23:59:59.999\",\"GXKSSJ\":\"2018-04-01 00:00:00.000\",\"VERSION\":\"1.3\",\"YWLX\":\"KTGG\"}")
					.getBytes("UTF-8");

			// 使用私钥对摘要进行加密 获得密文
			byte[] signpri_pub = "RNF2YYDhW9F8vYocLKcSopw/D2aa4HN/OC0OVtHNY6rRS39rBjsDw7fDVFLw9zoBD15K2zMJwiXQt0uf652Wh6DMJ8XWOtPJ4k7SU9xc5EAGy2DRfs0CKoanG53dKwepG4U6zSctv/Kap5gO1FvZ24GAJ3MQeVrgeGjyKEOpNeo="
					.getBytes();// encryptByRSA1((byte[]) v[0], sourcepri_pub);
