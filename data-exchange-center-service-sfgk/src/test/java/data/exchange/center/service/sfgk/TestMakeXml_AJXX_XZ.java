...
public class TestMakeXml_AJXX_XZ {
	...
	public static void main(String[] args) throws IOException {
	    ...
	    node1.addElement("提起行政赔偿代码").addText("");
	    node1.addElement("提起行政赔偿名称").addText("");
	    node1.addElement("标的物").addText("");
	    node1.addElement("标的行为名称").addText("");
	    node1.addElement("标的行为代码").addText("");
	    node1.addElement("诉讼标的额").addText("");
	    node1.addElement("行政管理范围代码").addText("");
	    node1.addElement("行政管理范围名称").addText("");
	    ...
	    r11.addElement("地址").addText("");
	    r11.addElement("提起赔偿金额").addText("");

	    Element node12 = root.addElement("当事人诉讼代理人");
	    ...
	    Element node13 = root.addElement("被告行政行为");
	    Element r13 = node13.addElement("R");
	    r13.addElement("编号").addText("");
	    r13.addElement("案件编号").addText("");
	    r13.addElement("序号").addText("");
	    r13.addElement("被告").addText("");
	    r13.addElement("被告类型代码").addText("");
	    r13.addElement("被告类型名称").addText("");
	    r13.addElement("行政行为种类代码").addText("");
	    r13.addElement("行政行为种类名称").addText("");
	    r13.addElement("做出行政行为日期").addText("");
	    r13.addElement("赔偿处理代码").addText("");
	    r13.addElement("赔偿处理名称").addText("");
	    r13.addElement("赔偿方式代码").addText("");
	    r13.addElement("赔偿方式名称").addText("");
	    r13.addElement("赔偿金额").addText("");

	    Element node14 = root.addElement("审判组织成员");
	    Element r14 = node14.addElement("R");
	    r14.addElement("编号").addText("");
	    r14.addElement("案件编号").addText("");
	    r14.addElement("序号").addText("");
	    r14.addElement("姓名").addText("");
	    r14.addElement("角色代码").addText("");
	    r14.addElement("角色名称").addText("");
	    r14.addElement("联系电话").addText("");

	    Element node15 = root.addElement("审判组织成员变更");
	    Element r15 = node15.addElement("R");
	    r15.addElement("编号").addText("");
	    r15.addElement("案件编号").addText("");
	    r15.addElement("序号").addText("");
	    r15.addElement("原成员").addText("");
	    r15.addElement("变更原因代码").addText("");
	    r15.addElement("变更原因名称").addText("");
	    r15.addElement("新成员").addText("");
	    r15.addElement("新成员角色代码").addText("");
	    r15.addElement("新成员角色名称").addText("");
	    r15.addElement("变更日期").addText("");

	    Element node16 = root.addElement("回避信息");
	    Element r16 = node16.addElement("R");
	    r16.addElement("编号").addText("");
	    r16.addElement("案件编号").addText("");
	    r16.addElement("序号").addText("");
	    r16.addElement("回避类型代码").addText("");
	    r16.addElement("回避类型名称").addText("");
	    r16.addElement("被申请回避角色代码").addText("");
	    r16.addElement("被申请回避角色名称").addText("");
	    r16.addElement("被申请回避人").addText("");
	    r16.addElement("回避事由代码").addText("");
	    r16.addElement("回避事由名称").addText("");
	    r16.addElement("回避申请人").addText("");
	    r16.addElement("回避申请日期").addText("");
	    r16.addElement("回避决定人代码").addText("");
	    r16.addElement("回避决定人名称").addText("");
	    r16.addElement("决定日期").addText("");
	    r16.addElement("回避处理结果代码").addText("");
	    r16.addElement("回避处理结果名称").addText("");

	    Element node17 = root.addElement("诉讼保全和先予执行");
	    Element r17 = node17.addElement("R");
	    r17.addElement("编号").addText("");
	    r17.addElement("案件编号").addText("");
	    r17.addElement("序号").addText("");
	    r17.addElement("类型代码").addText("");
	    r17.addElement("类型名称").addText("");
	    r17.addElement("保全发动方代码").addText("");
	    r17.addElement("保全发动方名称").addText("");
	    r17.addElement("申请人").addText("");
	    r17.addElement("被申请人").addText("");
	    r17.addElement("申请日期").addText("");
	    r17.addElement("申请金额").addText("");
	    r17.addElement("申请财产").addText("");
	    r17.addElement("裁定日期").addText("");
	    r17.addElement("裁定结果代码").addText("");
	    r17.addElement("裁定结果名称").addText("");
	    r17.addElement("保全措施代码").addText("");
	    r17.addElement("保全措施名称").addText("");
	    r17.addElement("先予执行事由代码").addText("");
	    r17.addElement("先予执行事由名称").addText("");
	    r17.addElement("执行日期").addText("");
	    r17.addElement("实际执行金额").addText("");
	    r17.addElement("解除保全日期").addText("");
	    r17.addElement("解除保全原因代码").addText("");
	    r17.addElement("解除保全原因名称").addText("");

	    Element node18 = root.addElement("诉讼担保信息");
	    Element r18 = node18.addElement("R");
	    r18.addElement("编号").addText("");
	    r18.addElement("案件编号").addText("");
	    r18.addElement("序号").addText("");
	    r18.addElement("当事人").addText("");
	    r18.addElement("事由代码").addText("");
	    r18.addElement("事由名称").addText("");
	    r18.addElement("担保人").addText("");
	    r18.addElement("与当事人关系代码").addText("");
	    r18.addElement("与当事人关系名称").addText("");
	    r18.addElement("担保方式代码").addText("");
	    r18.addElement("担保方式名称").addText("");

	    Element node19 = root.addElement("证据信息");
	    Element r19 = node19.addElement("R");
	    r19.addElement("编号").addText("");
	    r19.addElement("案件编号").addText("");
	    r19.addElement("序号").addText("");
	    r19.addElement("证据名称").addText("");
	    r19.addElement("证据类型代码").addText("");
	    r19.addElement("证据类型名称").addText("");

	    Element node20 = root.addElement("程序变更");
	    node20.addElement("编号").addText("");
	    node20.addElement("案件编号").addText("");
	    node20.addElement("变更类型代码").addText("");
	    node20.addElement("变更类型名称").addText("");
	    node20.addElement("变更原因代码").addText("");
	    node20.addElement("变更原因名称").addText("");
	    node20.addElement("变更日期").addText("");

	    Element node21 = root.addElement("复议信息");
	    ...
	    r21.addElement("处理日期").addText("");
	    r21.addElement("处理结果代码").addText("");
	    r21.addElement("处理结果名称").addText("");

	    Element node22 = root.addElement("裁判文书上网信息");
	    ...
	    r22.addElement("上网时间").addText("");
	    r22.addElement("查询方式").addText("");

	    Element node23 = root.addElement("送达信息");
	    Element r23 = node23.addElement("R");
	    r23.addElement("编号").addText("");
	    r23.addElement("案件编号").addText("");
	    r23.addElement("序号").addText("");
	    r23.addElement("文书类型代码").addText("");
	    r23.addElement("文书类型名称").addText("");
	    r23.addElement("送达方式代码").addText("");
	    r23.addElement("送达方式名称").addText("");
	    r23.addElement("受送达人").addText("");
	    r23.addElement("送达日期").addText("");
	    r23.addElement("签收时间").addText("");
