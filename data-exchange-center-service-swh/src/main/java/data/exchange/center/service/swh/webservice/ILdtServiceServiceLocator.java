...
public class ILdtServiceServiceLocator extends org.apache.axis.client.Service implements data.exchange.center.service.swh.webservice.ILdtServiceService {
    ...
    private java.lang.String ILdtServicePort_address = "http://150.0.2.146:8090/court/service/LdtService";
    ...
    public data.exchange.center.service.swh.webservice.ILdtService getILdtServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public data.exchange.center.service.swh.webservice.ILdtService getILdtServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            data.exchange.center.service.swh.webservice.ILdtServiceServiceSoapBindingStub _stub = new data.exchange.center.service.swh.webservice.ILdtServiceServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (data.exchange.center.service.swh.webservice.ILdtService.class.isAssignableFrom(serviceEndpointInterface)) {
                data.exchange.center.service.swh.webservice.ILdtServiceServiceSoapBindingStub _stub = new data.exchange.center.service.swh.webservice.ILdtServiceServiceSoapBindingStub(new java.net.URL(ILdtServicePort_address), this);
                _stub.setPortName(getILdtServicePortWSDDServiceName());
                return _stub;
            }
        }
