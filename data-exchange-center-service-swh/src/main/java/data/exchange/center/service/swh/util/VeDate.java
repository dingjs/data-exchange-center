...
public class VeDate {
	 ...
	 * @return 返回短时间字符串格式yyyy-MM-dd
	 */
	public static int getIntDateShort() {
		Date currentTime = new Date();
	...
	public static String strDateToDate(String strDate) throws Exception {
	 ...
	 * 时间前推或后推分钟,其中JJ表示分钟.
	 */
	public static String getPreTime(String sj1, String jj,String formatter) {
	 ...
	 public static String getSubtractTime(String sj1, String jj,String formatter) {
			SimpleDateFormat format = null;
			if(formatter == null){
				 format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
			}else {
     ...
     * return
     */
    public static Date plusMonth(final Date date, final int month) {
        try {
            java.util.Calendar calendar = java.util.Calendar.getInstance();
            calendar.setTime(date);
            int currMonth = java.util.Calendar.MONTH;
            calendar.set(currMonth, calendar.get(currMonth) + month); //让日期加 month月 
    ...
    public static Date strToDate(final String str, String dateFormat,
        ...
        try {
            ...
            DateFormat fmt = new SimpleDateFormat(dateFormat, new Locale(lang));
            return fmt.parse(str.trim());
     ...
     * return
     */
    public static Date subtractMonth(final Date date, final int month) {
        try {
            java.util.Calendar calendar = java.util.Calendar.getInstance();
            calendar.setTime(date);
            int currMonth = java.util.Calendar.MONTH;
            calendar.set(currMonth, calendar.get(currMonth) - month); //让日期减 day天 
     ...
     * return
     */
    public static Date plusDateHour(final Date date, final int hour) {
        try {
            java.util.Calendar calendar = java.util.Calendar.getInstance();
            calendar.setTime(date);
            int currDay = java.util.Calendar.HOUR_OF_DAY;

            calendar.set(currDay, calendar.get(currDay) + hour); //让日期加 hour小时
     ...
     * return
     */
    public static Date subtractHour(final Date date, final int hour) {
        try {
            java.util.Calendar calendar = java.util.Calendar.getInstance();
            calendar.setTime(date);
            int currDay = java.util.Calendar.HOUR_OF_DAY;

            calendar.set(currDay, calendar.get(currDay) - hour); //让日期减 hour小时
            return calendar.getTime();
        } catch (Exception ex) {
            return null;
        }
     ...
     * return
     */
    public static Date subtractYear(final Date date, final int year) {
        try {
            java.util.Calendar calendar = java.util.Calendar.getInstance();
            calendar.setTime(date);
            int currYear = java.util.Calendar.YEAR;
            calendar.set(currYear, calendar.get(currYear) - year); //让日期减 年数 
     ...
     * @return
     */
    public static int getDateWeek(String date, String dateFormat) {
        try {
            return getDateWeek(strToDate(date, dateFormat));
        } catch (Exception e) {
        }
        return 0;
    }
