 ...
 * Description:
 * <p>Company: xinya </p>
 * <p>Date:2018年1月24日 上午10:31:49</p>
 * @author Wen.Yuguang
 * @version 1.0
 *
 */
@Service
public class ParseStorageTongdahaiServiceImpl implements ParseStorageTongdahaiService {

    private static Logger                logger = LoggerFactory.getLogger(ParseStorageTongdahaiServiceImpl.class);
    @Autowired
    ...
    @Override
    public ConcurrentMap<String, Object> parseStorageTongdahai(String ajbs) throws Exception {
         ...
         */
        XmlContent xmlContent = parseStorageTongdahaiMapper.getXML(map);
        ...
        if(!StringUtils.isEmpty(xmlMap.get("msg"))){
            ...
            if(set.size()>1){
                 ...
                 * 表元数据
                 */
                List<ColMeta> colMetaList = parseStorageTongdahaiMapper.getColMeta(ajlxEname);
...
--                  JARQ                            BUF_EXTERNAL2XML.JARQ
    ...
    private void delete(Map<String, Object> xmlMap, String ajlxEname) throws Exception {
        List<TableMeta> tableMetaList = parseStorageTongdahaiMapper.getTableMeta(ajlxEname);
    ...
    private Map<String, Object> parseXml(String xml) {
        ...
        AjlxMeta ajlxMeta=null;
        try {
            ajlxMeta = parseStorageTongdahaiMapper.getAjlxMetaC(rootElement.getName());
        }
        catch (Exception e) {
