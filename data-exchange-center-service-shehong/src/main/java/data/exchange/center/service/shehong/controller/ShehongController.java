package data.exchange.center.service.shehong.controller;
...
@RestController
public class ShehongController {

	@Autowired
	private ShehongService shehongService;
	...
	public Object getAjbsList(
		...
		return shehongService.getAjbsList(startDateTime, endDateTime, fydm);
	}
	...
	public Object getAjbsInfo(
		...
		return shehongService.getAjbsInfo(ajbs, fydm, ajlx);
	}
	...
	public Object getAjclList(
		...
		return shehongService.getAjclList(ajbs, fydm, ajlx);
	}
	...
	public Object getAjcl(
		...
		return shehongService.getAjcl(ajbs, xh);
	}
	...
	public Object getUserInfo(
		...
		return shehongService.getUserInfo(fydm);
	}
	...
	public Object getBmInfo() throws Exception{
		return shehongService.getBmInfo();
	}
}
