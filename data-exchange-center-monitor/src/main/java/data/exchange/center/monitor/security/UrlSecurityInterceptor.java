...
/**
 * 
 * Description:spring security默认的url授权方式需要预先硬编码在配置中，这里改写默认方式
 * <p>Company: xinya </p>
 * <p>Date:2017年7月26日 上午9:50:05</p>
 * @author Wen.Yuguang
 * @version 1.0
 *
 */
...
public class UrlSecurityInterceptor extends FilterSecurityInterceptor {
    ...
    private boolean isSecurityUrl(String url){
        ...
        return ! resources.stream().filter(item->pathMatcher.match(item.gettUrl(),url)).collect(Collectors.toList()).isEmpty();
