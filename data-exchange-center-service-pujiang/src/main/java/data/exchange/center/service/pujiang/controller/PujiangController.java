package data.exchange.center.service.pujiang.controller;
...
@RestController
public class PujiangController {

	@Autowired
	private PujiangService pujiangService;
	...
	public Object getAjbsList(
		...
		return pujiangService.getAjbsList(startDateTime, endDateTime, fydm);
	}
	...
	public Object getAjbsInfo(
		...
		return pujiangService.getAjbsInfo(ajbs, fydm, ajlx);
	}
	...
	public Object getAjclList(
		...
		return pujiangService.getAjclList(ajbs, fydm, ajlx);
	}
	...
	public Object getAjcl(
		...
		return pujiangService.getAjcl(ajbs, xh);
	}
	...
	public Object getUserInfo(
		...
		return pujiangService.getUserInfo(fydm);
	}
	...
	public Object getBmInfo() throws Exception{
		return pujiangService.getBmInfo();
	}
}
